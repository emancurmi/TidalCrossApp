			...
			<div className="col-sm-12">
				<div className="card">
					...
					<div class="card-body">
						...
						<h2>Contacting us</h2>
						<p>If you would like to contact us to understand more about this Policy or wish to contact us concerning any matter relating to our use of cookies, you may send an email to &#105;nfo&#64;t&#105;dal&#99;ros&#115;.&#99;o&#109;</p>
					</div>
					...
					<div className="card-footer bg-transparent d-sm-flex justify-content-sm-between align-items-sm-center border-top-0 pt-0 pb-3">
						<p className="list-inline list-inline-dotted text-muted mb-3 mb-sm-0">This document was last updated on February 22, 2021</p>
					</div>
				</div>
			</div>
		)
